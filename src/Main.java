 ...
 */
class Program extends GLJPanel implements GLEventListener  {
    ...
    public void PyramidBaseOnCircle(GL2 gl2,int numVertices){
        ...
        {
            gl2.glBegin(GL2.GL_POLYGON); // generate triangles
            x = (float) (radius * Math.cos(angle));
            z = (float) (radius * Math.sin(angle));

            gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[6],2); // setup material

            gl2.glVertex3f( x, -2.0f, z ); // generate triangles
            gl2.glVertex3f( 0.0f, 4.0f, 0.0f ); // cone position
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float[] GL_AMBIENT_AND_DIFFUSE = { 0.8f, 0.8f, 0.8f, 1f }; // Set neutral colors
        gl2.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT, GL_AMBIENT_AND_DIFFUSE,1); //setup light
    }
    ...
    private class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent evt) {
            ...
            prevX = evt.getX();
            dragging = true;
            Program.this.addMouseMotionListener(this);
        }
        public void mouseReleased(MouseEvent evt) {
            dragging = false;
            Program.this.removeMouseMotionListener(this);
        }
